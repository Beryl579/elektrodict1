  ...
  },
{
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "<p><strong>Limit Betz</strong> \\(C_{p,max}=16/27≈59,3\\%\\) — tidak ada turbin bisa tangkap >59% energi angin (hukum kekekalan massa & momentum, Betz 1919).</p><p>Turbin nyata \\(C_p\\) 0,35–0,45. \\(C_p\\) fungsi <strong>TSR</strong> (\\(\\lambda\\)):</p>$$\\lambda = \\frac{\\omega R}{v} = \\frac{\\text{kecepatan ujung bilah}}{\\text{kecepatan angin}}$$<p>HAWT optimal \\(\\lambda\\) 6–8, VAWT Darrieus 4–5.</p><div class=\"mt-img-wrap\"><img class=\"mt-img\" src=\"Asset%20Materi/Wind_turbine_power_curve.svg\" alt=\"Kurva Cp vs TSR\" loading=\"lazy\" onclick=\"openMateriImg(this)\"><div class=\"mt-img-cap\">Kurva \\(C_p\\) vs TSR — puncak di λ≈7 (HAWT) · sumber: Wikimedia Commons, <i>File:Wind turbine power curve.svg</i> (CC BY-SA 3.0)</div></div>",
      ...
      },
      {
        ...
        "emoji": "🔄",
        "title": "HAWT vs VAWT",
        "body": "<table class=\"mt-table\"><thead><tr><th>Tipe</th><th>Sumbu</th><th>Cp max</th><th>Pro/Kontra</th></tr></thead><tbody><tr><td><strong>HAWT</strong> 3 bilah</td><td>Horizontal</td><td>0,45</td><td>Efisien, butuh yaw, tinggi</td></tr><tr><td><strong>VAWT Darrieus</strong></td><td>Vertikal</td><td>0,35</td><td>Tidak butuh yaw, Cp rendah</td></tr><tr><td><strong>Savonius</strong></td><td>Vertikal drag</td><td>0,15</td><td>Self-start, untuk pompa</td></tr></tbody></table><div class=\"mt-img-wrap\"><img class=\"mt-img\" src=\"Asset%20Materi/Darrieus_wind_turbine.svg\" alt=\"VAWT Darrieus\" loading=\"lazy\" onclick=\"openMateriImg(this)\"><div class=\"mt-img-cap\">VAWT Darrieus — bilah vertikal melengkung, tidak perlu yaw · sumber: Wikimedia Commons, <i>File:Darrieus wind turbine.svg</i> (CC BY-SA 3.0)</div></div><p>Di Indonesia, HAWT dominan untuk grid (Sidrap), VAWT cocok untuk urban/micro.</p>",
  ...
  },
{
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "<table class=\"mt-table\"><thead><tr><th>Turbin</th><th>Head</th><th>Q</th><th>Impulse/Reaction</th></tr></thead><tbody><tr><td><strong>Pelton</strong></td><td>>150m (tinggi)</td><td>Kecil</td><td>Impulse (jet)</td></tr><tr><td><strong>Francis</strong></td><td>30–300m</td><td>Sedang</td><td>Reaction</td></tr><tr><td><strong>Kaplan</strong></td><td><30m</td><td>Besar</td><td>Reaction, baling variabel</td></tr><tr><td><strong>Crossflow</strong></td><td>5–80m</td><td>Sedang</td><td>Impulse, micro-hydro murah</td></tr></tbody></table><div class=\"mt-img-wrap\"><img class=\"mt-img\" src=\"Asset%20Materi/Pelton_wheel.svg\" alt=\"Pelton wheel\" loading=\"lazy\" onclick=\"openMateriImg(this)\"><div class=\"mt-img-cap\">Pelton — mangkuk ganda disembur jet · sumber: Wikimedia Commons, <i>File:Pelton wheel.svg</i> (CC BY-SA 3.0)</div></div><div class=\"mt-img-wrap\"><img class=\"mt-img\" src=\"Asset%20Materi/Francis_turbine.svg\" alt=\"Francis turbine\" loading=\"lazy\" onclick=\"openMateriImg(this)\"><div class=\"mt-img-cap\">Francis — runner spiral, guide vane · sumber: Wikimedia Commons, <i>File:Francis turbine.svg</i> (CC BY-SA 3.0)</div></div>",
      ...
      },
      {
        ...
        "body": "<p>Pumped storage: pompa air ke atas saat surplus PV/angin (malam), turun saat peak. Efisiensi siklus 70–80%. Upper & lower reservoir — Cisokan (2×520MW) terbesar SE Asia.</p><p>Fungsi grid: peaker, inertia, black start — vital untuk EBT variabel.</p><div class=\"mt-img-wrap\"><img class=\"mt-img\" src=\"Asset%20Materi/Pumped-storage_hydroelectricity.svg\" alt=\"Pumped storage\" loading=\"lazy\" onclick=\"openMateriImg(this)\"><div class=\"mt-img-cap\">Pumped storage — pompa (charge) & turbin (discharge) · sumber: Wikimedia Commons, <i>File:Pumped-storage hydroelectricity.svg</i> (CC BY-SA 3.0)</div></div>",
  ...
  },
{
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "<p>Gasifikasi partial oxidation (700–900°C, O₂ terbatas) → <strong>syngas</strong> (CO 20%, H₂ 15%, CH₄ 3%, CO₂ 10%, N₂ sisa) dengan LHV syngas ~5 MJ/Nm³.</p><table class=\"mt-table\"><thead><tr><th>Tipe Gasifier</th><th>Scale</th><th>Tar</th></tr></thead><tbody><tr><td>Updraft</td><td>Kecil</td><td>Tinggi</td></tr><tr><td>Downdraft</td><td>10kW–1MW</td><td>Rendah</td></tr><tr><td>Fluidized bed</td><td>>1MW</td><td>Sedang</td></tr></tbody></table><p>Syngas → gas engine atau co-firing di PLTU batubara.</p><div class=\"mt-img-wrap\"><img class=\"mt-img\" src=\"Asset%20Materi/Gasification_process.svg\" alt=\"Proses gasifikasi\" loading=\"lazy\" onclick=\"openMateriImg(this)\"><div class=\"mt-img-cap\">Proses gasifikasi biomassa → syngas · sumber: Wikimedia Commons, <i>File:Gasification process.svg</i> (CC BY-SA 3.0)</div></div>",
      ...
      },
      {
        ...
        "body": "<p><strong>Biogas</strong> 55–65% CH₄ + 35–45% CO₂, LHV ~21 MJ/Nm³. Digester: <strong>hydrolysis → acidogenesis → acetogenesis → methanogenesis</strong> (bakteri metanogen, 35°C mesofilik, retention 20–30 hari).</p><div class=\"mt-img-wrap\"><img class=\"mt-img\" src=\"Asset%20Materi/Biogas_plant.svg\" alt=\"Skema digester biogas\" loading=\"lazy\" onclick=\"openMateriImg(this)\"><div class=\"mt-img-cap\">Skema biogas plant: inlet → digester → gas holder → genset · sumber: Wikimedia Commons, <i>File:Biogas plant.svg</i> (CC BY-SA 4.0)</div></div><p>1 ton kotoran sapi → 40 Nm³ biogas → 80 kWh listrik. Limbah cair jadi pupuk.</p>",
    ...
    "sections": [
      {
        ...
        "body": "<p>Indonesia di Ring of Fire → heat flow 100 mW/m², reservoir 150–350°C di kedalaman 1–3 km (volkano). 3 tipe: <strong>hydrothermal</strong> (air), <strong>hot dry rock</strong> (EGS), <strong>geopressured</strong>.</p><div class=\"mt-img-wrap\"><img class=\"mt-img\" src=\"Asset%20Materi/Geothermal_energy.svg\" alt=\"Energi panas bumi\" loading=\"lazy\" onclick=\"openMateriImg(this)\"><div class=\"mt-img-cap\">Skema panas bumi: magma → reservoir → cap rock → sumur produksi · sumber: Wikimedia Commons, <i>File:Geothermal energy.svg</i> (CC BY-SA 3.0)</div></div><p>Gradient geotermal 30°C/km (normal), di vulkanik bisa 100°C/km — sumur 2km bisa 250°C.</p>",

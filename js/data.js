const KAMUS = [
  ...
  {en:"RMS Voltage",id:"Tegangan RMS",kat:"daya",desc:"Nilai efektif tegangan AC yang setara dengan daya DC.",detail:"220V AC PLN adalah nilai RMS. Nilai puncak lebih besar: Vpeak = 220-ˆš2 -‰ˆ 311V.",formula:"V_{rms} = \\frac{V_m}{\\sqrt{2}} \\approx 0.707 V_m",tags:["efektif","peak","AC","220V","RMS"]},
  // -”€-”€ ELEKTRONIKA -”€-”€
  {en:"Op-Amp",id:"Op-Amp (Penguat Operasional)",kat:"elektronika",desc:"IC penguat diferensial tegangan tinggi.",detail:"Dua input (inverting -ˆ’, non-inverting +) dan satu output. Penguatan open-loop sangat tinggi (~100.000). Dikontrol dengan feedback.",formula:"V_{out} = A_{OL}(V_+ - V_-)",tags:["IC","penguat","feedback","741","LM358"]},
  {en:"Inverting Amplifier",id:"Penguat Pembalik",kat:"elektronika",desc:"Konfigurasi op-amp dengan output berlawanan fasa input.",detail:"Input terhubung ke terminal inverting (-ˆ’) melalui Ri. Feedback dari output ke -ˆ’ melalui Rf.",formula:"A_v = -\\frac{R_f}{R_i}",tags:["op-amp","feedback","penguatan","inverting"]},
  ...
  {en:"Comparator",id:"Komparator",kat:"elektronika",desc:"Rangkaian pembanding dua tegangan.",detail:"Output HIGH jika V+ > V-ˆ’, LOW jika sebaliknya. Digunakan dalam ADC, level detector, dan osilator Schmitt.",formula:"V_{out} = \\begin{cases}+V_{sat} & V_+>V_- \\\\ -V_{sat} & V_+<V_-\\end{cases}",tags:["op-amp","level detector","ADC","schmitt trigger"]},

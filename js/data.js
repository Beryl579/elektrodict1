const KAMUS = [
  ...
  {en:"Open Circuit",id:"Rangkaian Terbuka",kat:"dasar",desc:"Jalur arus yang terputus â€” arus tidak mengalir.",detail:"Terjadi ketika konduktor putus atau sakelar terbuka. Tegangan sumber tetap ada tapi arus = 0.",formula:"I = 0 \\;\\; V_{oc} = V_s",tags:["putus","sakelar","tegangan terbuka"]},
  {en:"Conductance",id:"Konduktansi",kat:"dasar",desc:"Kebalikan dari hambatan â€” kemampuan menghantarkan arus.",detail:"Semakin besar konduktansi, semakin mudah arus mengalir. Simbol G, satuan Siemens (S).",formula:"G = \\frac{1}{R} \\;\\; (\\text{Siemens})",tags:["siemens","konduktor","G"]},
  ...
  {en:"Transformer",id:"Transformator",kat:"komponen",desc:"Perangkat pengubah level tegangan AC.",detail:"Bekerja berdasarkan induksi elektromagnetik â€” kopling dua kumparan melalui inti besi.",formula:"\\frac{V_s}{V_p} = \\frac{N_s}{N_p} = \\frac{I_p}{I_s}",tags:["step-up","step-down","lilitan","PLN"]},
  ...
  // â”€â”€ RANGKAIAN â”€â”€
  {en:"Kirchhoff's Current Law",id:"KCL â€” Hukum Kirchhoff Arus",kat:"rangkaian",desc:"Jumlah arus masuk = jumlah arus keluar di node.",detail:"Berdasarkan hukum kekekalan muatan listrik. Total arus yang masuk ke suatu simpul sama dengan total arus yang keluar.",formula:"\\sum I_{masuk} = \\sum I_{keluar}",tags:["KCL","node","simpul","analisis rangkaian"]},
  {en:"Kirchhoff's Voltage Law",id:"KVL â€” Hukum Kirchhoff Tegangan",kat:"rangkaian",desc:"Jumlah tegangan dalam satu loop tertutup = 0.",detail:"Berdasarkan hukum kekekalan energi. Tegangan naik (sumber) sama dengan tegangan jatuh (beban) dalam satu mesh.",formula:"\\sum V = 0 \\;\\; (\\text{satu loop})",tags:["KVL","loop","mesh","analisis rangkaian"]},
  ...
  {en:"Superposition Theorem",id:"Teorema Superposisi",kat:"rangkaian",desc:"Respons total = jumlah respons dari tiap sumber secara independen.",detail:"Berlaku untuk rangkaian linear. Matikan sumber lain (tegangan â†’ short, arus â†’ open) saat menganalisis satu sumber.",formula:"V_{total} = V_1 + V_2 + \\cdots + V_n",tags:["analisis","linear","superposisi","teorema"]},
  ...
  {en:"RC Time Constant",id:"Konstanta Waktu RC",kat:"rangkaian",desc:"Waktu yang dibutuhkan kapasitor mengisi/dikosongkan 63.2%.",detail:"Setelah 5Ï„, kapasitor dianggap penuh terisi/kosong. Digunakan dalam filter, timer, dan integrator.",formula:"\\tau = RC \\;\\; V(t) = V_s(1-e^{-t/\\tau})",tags:["tau","charging","filter","timer","RC"]},
  {en:"RL Time Constant",id:"Konstanta Waktu RL",kat:"rangkaian",desc:"Waktu respons induktor terhadap perubahan arus.",detail:"Induktor menentang perubahan arus mendadak. Setelah 5Ï„, arus dianggap stabil.",formula:"\\tau = \\frac{L}{R} \\;\\; I(t) = \\frac{V}{R}(1-e^{-t/\\tau})",tags:["tau","induktor","RL","transien"]},
  // â”€â”€ DAYA â”€â”€
  ...
  {en:"Power Factor",id:"Faktor Daya",kat:"daya",desc:"Rasio daya aktif terhadap daya semu.",detail:"Nilai 1 = ideal. Beban induktif â†’ lagging, beban kapasitif â†’ leading. Perbaikan PF dengan bank kapasitor.",formula:"PF = \\cos\\varphi = \\frac{P}{S}",tags:["cos phi","efisiensi","lagging","leading","koreksi"]},
  {en:"Energy",id:"Energi Listrik",kat:"daya",desc:"Total daya yang dikonsumsi selama selang waktu tertentu.",detail:"Diukur dalam kWh oleh PLN untuk tagihan listrik. 1 kWh = 1000 Watt Ã— 1 jam = 3,6 MJ.",formula:"W = P \\cdot t \\;\\; (\\text{kWh atau Joule})",tags:["kWh","tagihan","konsumsi","joule"]},
  {en:"Efficiency",id:"Efisiensi",kat:"daya",desc:"Perbandingan daya output dengan daya input.",detail:"Selisih daya input dan output adalah rugi-rugi (panas, gesekan). Transformator ideal Î· mendekati 99%.",formula:"\\eta = \\frac{P_{out}}{P_{in}} \\times 100\\%",tags:["rugi-rugi","transformator","motor","efisiensi"]},
  {en:"Three-Phase Power",id:"Daya Tiga Fasa",kat:"daya",desc:"Sistem distribusi AC tiga fasa bergeser 120Â°.",detail:"Lebih efisien dari single-phase untuk transmisi daya. Digunakan di industri dan PLN distribusi.",formula:"P_{3\\phi} = \\sqrt{3}\\cdot V_L \\cdot I_L \\cdot \\cos\\varphi",tags:["tiga fasa","industri","PLN","transmisi","star","delta"]},
  {en:"RMS Voltage",id:"Tegangan RMS",kat:"daya",desc:"Nilai efektif tegangan AC yang setara dengan daya DC.",detail:"220V AC PLN adalah nilai RMS. Nilai puncak lebih besar: Vpeak = 220âˆš2 â‰ˆ 311V.",formula:"V_{rms} = \\frac{V_m}{\\sqrt{2}} \\approx 0.707 V_m",tags:["efektif","peak","AC","220V","RMS"]},
  // â”€â”€ ELEKTRONIKA â”€â”€
  {en:"Op-Amp",id:"Op-Amp (Penguat Operasional)",kat:"elektronika",desc:"IC penguat diferensial tegangan tinggi.",detail:"Dua input (inverting âˆ’, non-inverting +) dan satu output. Penguatan open-loop sangat tinggi (~100.000). Dikontrol dengan feedback.",formula:"V_{out} = A_{OL}(V_+ - V_-)",tags:["IC","penguat","feedback","741","LM358"]},
  {en:"Inverting Amplifier",id:"Penguat Pembalik",kat:"elektronika",desc:"Konfigurasi op-amp dengan output berlawanan fasa input.",detail:"Input terhubung ke terminal inverting (âˆ’) melalui Ri. Feedback dari output ke âˆ’ melalui Rf.",formula:"A_v = -\\frac{R_f}{R_i}",tags:["op-amp","feedback","penguatan","inverting"]},
  {en:"Non-Inverting Amplifier",id:"Penguat Non-Pembalik",kat:"elektronika",desc:"Konfigurasi op-amp output sefasa dengan input.",detail:"Input ke terminal non-inverting (+). Penguatan selalu â‰¥ 1. Impedansi input sangat tinggi.",formula:"A_v = 1 + \\frac{R_f}{R_1}",tags:["op-amp","non-inverting","penguatan","buffer"]},
  {en:"Comparator",id:"Komparator",kat:"elektronika",desc:"Rangkaian pembanding dua tegangan.",detail:"Output HIGH jika V+ > Vâˆ’, LOW jika sebaliknya. Digunakan dalam ADC, level detector, dan osilator Schmitt.",formula:"V_{out} = \\begin{cases}+V_{sat} & V_+>V_- \\\\ -V_{sat} & V_+<V_-\\end{cases}",tags:["op-amp","level detector","ADC","schmitt trigger"]},
  ...
  {en:"PWM",id:"Modulasi Lebar Pulsa (PWM)",kat:"elektronika",desc:"Teknik mengontrol daya dengan mengubah duty cycle.",detail:"Frekuensi tetap, lebar pulsa bervariasi 0â€“100%. Digunakan untuk motor DC, LED dimmer, dan power supply switching.",formula:"\\text{Duty Cycle} = \\frac{t_{on}}{T} \\times 100\\%",tags:["duty cycle","motor","dimmer","switching","Arduino"]},
  ...
  {en:"Bode Plot",id:"Plot Bode",kat:"sinyal",desc:"Grafik respons frekuensi sistem (magnitude dan fase).",detail:"Digunakan untuk analisis stabilitas sistem dan desain filter. Menampilkan Gain (dB) dan Fase (Â°) vs frekuensi (log).",formula:"|H(j\\omega)|_{dB} = 20\\log_{10}|H(j\\omega)|",tags:["respons frekuensi","stabilitas","sistem kontrol","gain"]},
  ...
  {en:"Phase",id:"Fasa",kat:"sinyal",desc:"Posisi relatif suatu gelombang dalam satu siklus.",detail:"Dinyatakan dalam derajat (Â°) atau radian (rad). Dua sinyal sefasa (0Â°) atau berlawanan fasa (180Â°).",formula:"v(t) = V_m\\sin(\\omega t + \\varphi)",tags:["sudut fasa","sinus","AC","lagging","leading"]},
  // â”€â”€ LEBIH BANYAK ISTILAH â”€â”€
  ...
  {en:"Magnetic Flux",id:"Fluks Magnetik",kat:"dasar",desc:"Total garis gaya magnet yang menembus suatu permukaan.",detail:"Simbol Î¦, satuan Weber (Wb). Bergantung pada kekuatan medan B, luas permukaan A, dan sudut.",formula:"\\Phi = B \\cdot A \\cdot \\cos\\theta \\;\\; (\\text{Weber})",tags:["weber","medan magnet","fluks","induksi"]},
  ...
  {en:"Power Supply",id:"Catu Daya",kat:"elektronika",desc:"Rangkaian mengubah tegangan AC menjadi DC yang stabil.",detail:"Terdiri dari: transformator â†’ penyearah â†’ filter kapasitor â†’ regulator. Output stabil meski input atau beban berubah.",formula:"V_{dc} = V_{rms}\\sqrt{2} - V_f",tags:["DC supply","regulasi","transformator","filter","regulator"]},
  ...
  {en:"Magnetic Field",id:"Medan Magnet",kat:"dasar",desc:"Wilayah di sekitar magnet atau arus listrik yang menimbulkan gaya magnet.",detail:"Simbol B (Tesla) atau H (A/m). Arus listrik selalu dikelilingi medan magnet â€” kaidah tangan kanan.",formula:"B = \\mu_0 \\frac{I}{2\\pi r} \\;\\; (\\text{kawat lurus})",tags:["tesla","induksi","elektromagnet","kaidah tangan kanan"]},
  ...
  {en:"Common Emitter",id:"Common Emitter",kat:"elektronika",desc:"Konfigurasi transistor paling umum â€” penguatan tegangan tinggi.",detail:"Emitter di-ground, input ke Base, output dari Collector. Penguatan tegangan besar tapi ada pergeseran fasa 180Â°.",formula:"A_v = -\\frac{R_C}{r_e} \\;\\; r_e=\\frac{26mV}{I_C}",tags:["transistor","BJT","penguatan","amplifier","CE"]},
  ...
  {en:"Charge",id:"Muatan Listrik",kat:"dasar",desc:"Sifat fundamental materi yang menimbulkan gaya elektromagnetik.",detail:"Muatan elektron: -1.6Ã—10â»Â¹â¹ C. Muatan proton: +1.6Ã—10â»Â¹â¹ C. Satuan: Coulomb.",formula:"Q = n \\cdot e \\;\\; e = 1.6 \\times 10^{-19} C",tags:["coulomb","elektron","proton","muatan dasar"]},
  ...
  {en:"Permittivity",id:"Permitivitas",kat:"dasar",desc:"Kemampuan material menyimpan energi medan listrik.",detail:"Permitivitas relatif Îµr (konstanta dielektrik) menentukan kapasitansi. Air: Îµr â‰ˆ 80, vakum: Îµr = 1.",formula:"C = \\varepsilon_r \\varepsilon_0 \\frac{A}{d}",tags:["dielektrik","kapasitor","konstanta","Îµr","kapasitansi"]},
  ...
  {en:"DC Motor",id:"Motor DC",kat:"daya",desc:"Mengubah energi listrik DC menjadi energi mekanik rotasi.",detail:"Kumparan dalam medan magnet â€” arus menyebabkan torsi (Hukum Lorentz). Dikontrol dengan PWM.",formula:"\\tau = BINA \\;\\; V = E_b + IR",tags:["torsi","putaran","PWM","armature","back-EMF"]},
  ...
  {en:"Solar Cell",id:"Sel Surya",kat:"terbarukan",desc:"Komponen pengubah cahaya matahari menjadi listrik.",detail:"Efek fotovoltaik di sambungan PN. Tegangan tiap sel â‰ˆ 0.5-0.6V. Panel surya = banyak sel seri/paralel.",formula:"I = I_L - I_0(e^{V/nV_T}-1)",tags:["fotovoltaik","PLTS","panel surya","renewable","inverter"]},
  ...
  // â”€â”€ EBT / TERBARUKAN TAMBAHAN â”€â”€
  ...
  // â”€â”€ ELEKTRONIKA DAYA (POWER ELECTRONICS) â”€â”€
  ...
  // â”€â”€ IoT & KONEKTIVITAS (DIGITAL/KOMUNIKASI) â”€â”€
  ...
  // â”€â”€ SENSOR INSTRUMENTASI INDUSTRI â”€â”€
...
const QUIZ_CATS = {
  dasar:      { label:'Dasar',       emoji:'âš¡', desc:'Tegangan, arus, hambatan, hukum dasar' },
  ...
  terbarukan: { label:'EBT',         emoji:'â˜€ï¸', desc:'Panel surya, turbin angin, inverter, MPPT, baterai' },
  instalasi:  { label:'Instalasi',   emoji:'ðŸ§¤', desc:'PUIL, grounding, kabel, MCB, safety K3' },
  mesin:      { label:'Mesin',       emoji:'âš™ï¸', desc:'Motor DC/AC, generator, trafo, mesin industri' },
...
const TIMELINE = [
  // ERA KUNO
  {year:1600,title:"De Magnete â€” Dasar Elektrostatik",person:"William Gilbert",era:"kuno",
  ...
  {year:1745,title:"Penemuan Kondensator â€” Leyden Jar",person:"Pieter van Musschenbroek",era:"kuno",
   desc:"Fisikawan Belanda menemukan Leyden Jar, kapasitor pertama dalam sejarah. Dapat menyimpan muatan listrik statik dalam jumlah besar â€” menjadi awal mula teori kapasitor.",
  ...
  // ERA MODERN
  {year:1800,title:"Baterai Pertama â€” Voltaic Pile",person:"Alessandro Volta",era:"modern",
  ...
  {year:1820,title:"Hukum Oersted â€” Elektromagnetisme",person:"Hans Christian Oersted",era:"modern",
  ...
  {year:1947,title:"Transistor Pertama",person:"Shockley, Bardeen & Brattain",era:"digital",
   desc:"Tim Bell Labs menemukan transistor point-contact â€” komponen semikonduktor yang bisa menguatkan sinyal dan berfungsi sebagai saklar. Transistor menggantikan tabung vakum yang besar dan boros daya.",
  ...
  {year:1958,title:"Integrated Circuit (IC) Pertama",person:"Jack Kilby & Robert Noyce",era:"digital",
   desc:"Kilby (Texas Instruments) dan Noyce (Fairchild) secara independen menciptakan IC pertama â€” menempatkan banyak transistor dalam satu chip silikon. Ini memulai era miniaturisasi elektronika.",
  ...
  {year:1971,title:"Mikroprosesor Pertama â€” Intel 4004",person:"Federico Faggin / Intel",era:"digital",
   desc:"Intel meluncurkan 4004, mikroprosesor komersial pertama di dunia dengan 2.300 transistor dalam satu chip. Ini adalah komputer lengkap dalam sekeping silikon berukuran 12mmÂ².",
  ...
  {year:1991,title:"Baterai Lithium-Ion Komersial",person:"John Goodenough / Sony",era:"kontemporer",
   desc:"Sony mengkomersialisasi baterai Li-ion berbasis riset Goodenough. Baterai ini lebih ringan, lebih padat energi, dan bisa diisi ulang ribuan kali â€” merevolusi perangkat portabel.",
  ...
  {year:2012,title:"Raspberry Pi & Era Maker",person:"Eben Upton",era:"kontemporer",
   desc:"Raspberry Pi diluncurkan dengan harga $35 â€” komputer lengkap seukuran kartu kredit. Bersama Arduino, ini melahirkan gerakan Maker/DIY elektronik global yang mendemokratisasi hardware.",
   impact:"Demokratisasi hardware & IoT"},
  {year:2022,title:"ChatGPT & AI dalam Elektronika",person:"OpenAI",era:"kontemporer",
   desc:"AI generatif mulai merevolusi desain elektronika â€” dari generasi kode HDL otomatis, optimasi layout PCB, hingga debugging rangkaian. Engineer elektro kini berkolaborasi dengan AI.",
...
// VIDEO PEMBELAJARAN â€” Channel YouTube Indonesia (elektronika)
...
const VIDEOS = [
  ...
  { id:'nVD1jczzR-I', title:'Teori Dasar Listrik â€” Mencari Arus / Ampere', channel:'TEKNIK LISTRIK', channelUrl:'https://www.youtube.com/@TEKNIKLISTRIK29', topic:'Dasar Listrik', desc:'Cara menghitung arus listrik (ampere) dari tegangan dan hambatan, dijelaskan langkah demi langkah.' },
  ...
  { id:'nWOdETgdytQ', title:'Listrik Dinamis â€” Rangkaian Hambatan Seri Paralel (Fisika SMP)', channel:'Le GuruLes', channelUrl:'https://www.youtube.com/@legurules', topic:'Dasar Listrik', desc:'Materi fisika SMP: hambatan pengganti, rangkaian seri dan paralel, lengkap dengan contoh soal.' },
  ...
  { id:'4HnIp-_Ml1A', title:'Fisika Kelas 12 â€” Konsep Hukum Kirchoff 1 Loop', channel:'Rizu san study', channelUrl:'https://www.youtube.com/@rizusanstudy5844', topic:'Dasar Listrik', desc:'Konsep dasar Hukum Kirchoff untuk analisis loop rangkaian listrik, cocok untuk pemula.' },
  { id:'v13nuOWjuZo', title:'Fisika Kelas 9 â€” Hambatan Listrik & Hukum Ohm', channel:'Ganesha Operation', channelUrl:'https://www.youtube.com/@GaneshaOperationOfficial', topic:'Dasar Listrik', desc:'Hambatan pada kawat penghantar dan penerapan Hukum Ohm, dijelaskan dengan cara yang mudah dipahami.' },

  // â”€â”€ ELEKTRONIKA & KOMPONEN â”€â”€
  { id:'eJchTrTKLAo', title:'Apa Itu Elektronika? â€” Ayo Belajar Elektronika EP 01', channel:'Bang Leo Elektro', channelUrl:'https://www.youtube.com/@bangleoelektro', topic:'Elektronika & Komponen', desc:'Pengantar dunia elektronika: apa itu komponen, arus, dan cara mulai belajar elektronika dari nol.' },
  { id:'CZVYxynjDlI', title:'Tutorial Elektronika Dasar untuk Pemula', channel:'BISA AI Academy', channelUrl:'https://www.youtube.com/@BISAAI', topic:'Elektronika & Komponen', desc:'Panduan elektronika dasar oleh staf IoT BISA AI â€” dari komponen hingga cara merangkai.' },
  ...
  { id:'Px5ma3U3U1k', title:'Resistor â€” Mengenal Komponen Elektronika Part 1', channel:'Asan Elektronika', channelUrl:'https://www.youtube.com/@asanelektronika', topic:'Elektronika & Komponen', desc:'Mengenal resistor: fungsi, jenis, dan cara menghitung nilai lewat kode warna, dijelaskan sederhana.' },
  ...
  { id:'PaLa97hOTp4', title:'Cara Membaca Nilai Resistor 5 Gelang Warna â€” Part 2', channel:'ODHE AL Channel', channelUrl:'https://www.youtube.com/@odhealchannel330', topic:'Elektronika & Komponen', desc:'Lanjutan membaca resistor 5 gelang warna: dari tabel kode hingga contoh nyata.' },
  ...
  { id:'0YSXEDgCyXg', title:'Cara Kerja Motor Listrik DC', channel:'Autoexpose', channelUrl:'https://www.youtube.com/@Autoexposeid', topic:'Motor Listrik', desc:'Prinsip kerja motor listrik DC â€” mengubah energi listrik menjadi gerak, dengan animasi yang jelas.' },

  // â”€â”€ ENERGI TERBARUKAN â”€â”€
  ...
  { id:'JzZGD7UXRyM', title:'IPA â€” Energi Terbarukan dan Tak Terbarukan', channel:'GIA Academy', channelUrl:'https://www.youtube.com/@GIAAcademy', topic:'Energi Terbarukan', desc:'Konsep energi terbarukan vs tak terbarukan: matahari, angin, air, dan lainnya.' },
  ...
  { id:'x-NPJYcrt84', title:'Energi Air â€” PLTA Cirata', channel:'museumlistrikpln', channelUrl:'https://www.youtube.com/@museumlistrikpln', topic:'Energi Terbarukan', desc:'Cara PLTA memanfaatkan aliran air untuk memutar turbin dan membangkitkan listrik.' },
  ...
  // â”€â”€ INSTALASI & PANEL â”€â”€
  { id:'SqQOkcKxOgA', title:'Belajar Instalasi Listrik Dasar â€” Pemula Langsung Paham', channel:'Guru Elektronika', channelUrl:'https://www.youtube.com/@guruelektronika', topic:'Instalasi & Panel', desc:'Instalasi listrik dasar untuk pemula: saklar, stop kontak, dan jalur kabel yang aman.' },
  ...
  // â”€â”€ DIGITAL & KONTROL â”€â”€
  { id:'xovWttK1IIM', title:'Belajar Bareng Komunitas Teknik Listrik â€” Gerbang Logika', channel:'TEKNIK LISTRIK', channelUrl:'https://www.youtube.com/@TEKNIKLISTRIK29', topic:'Digital & Kontrol', desc:'Pengenalan gerbang logika (AND, OR, NOT) untuk dasar sistem kontrol dan elektronika digital.' },
  ...
  { id:'4c9GwhuXpVc', title:'Memasang Instalasi PLC â€” Teknik Instalasi Tenaga Listrik', channel:'Direktorat SMK - Kemdikdasmen', channelUrl:'https://www.youtube.com/@DirektoratSMKKemendikdasmen', topic:'Digital & Kontrol', desc:'Praktik memasang instalasi PLC untuk otomasi industri, materi SMK Teknik Instalasi Tenaga Listrik.' },

  // â”€â”€ ARDUINO & IoT â”€â”€
  { id:'EN0Et74bBrU', title:'Tutorial Arduino 2024 â€” Dari 0 untuk Pemula', channel:'Dea Afrizal', channelUrl:'https://www.youtube.com/@deaafrizal', topic:'Arduino & IoT', desc:'Panduan dasar mikrokontroler Arduino Uno dari nol sampai bisa, langsung praktik.' },
  ...
  { id:'9dHfT9M0DYU', title:'#1 Pengenalan â€” Tutorial Arduino Indonesia', channel:'Sigit Indriyanto', channelUrl:'https://www.youtube.com/@neosigitindriyanto', topic:'Arduino & IoT', desc:'Seri tutorial Arduino Indonesia: pengenalan hardware dan komponen pendukung.' },
  { id:'mBdWGOKFWIc', title:'Arduino Uno Pin â€” Tutorial untuk Pemula', channel:'Siapa Tahu Penemuan', channelUrl:'https://www.youtube.com/@SiapaTahuPenemuan', topic:'Arduino & IoT', desc:'Mengenal nama dan fungsi setiap pin Arduino Uno beserta kegunaannya.' },
  { id:'NUZx5TLe4uo', title:'Tutorial Arduino Bahasa Indonesia â€” Data Type (3)', channel:'Coders Indonesia', channelUrl:'https://www.youtube.com/@codersindonesia', topic:'Arduino & IoT', desc:'Belajar tipe data pemrograman Arduino: integer, float, dan boolean.' },

  // â”€â”€ PLC, HMI & SCADA (dari dasar hingga kompleks) â”€â”€
  // DASAR
  ...
  { id:'59aLF8bxPoQ', title:'DASAR PLC â€” Komunitas Teknik Listrik', channel:'TEKNIK LISTRIK', channelUrl:'https://www.youtube.com/@TEKNIKLISTRIK29', topic:'PLC, HMI & SCADA', desc:'Materi dasar PLC dari komunitas Teknik Listrik â€” cocok untuk pemula dari SMK hingga otodidak.' },
  ...
  { id:'2tneV_ZeUSA', title:'Belajar Ladder Program PLC dari NOL | Episode 1 | Gerbang Logika AND', channel:'JAGO LISTRIK', channelUrl:'https://www.youtube.com/@JAGOLISTRIK', topic:'PLC, HMI & SCADA', desc:'Memahami cara kerja PLC dan ladder diagram dari nol â€” episode 1 membahas gerbang logika AND.' },
  // MENENGAH
  ...
  { id:'MhIb4JGlhvU', title:'Mengoperasikan PLC â€” Teknik Otomasi Industri', channel:'Direktorat SMK - Kemdikdasmen', channelUrl:'https://www.youtube.com/@DirektoratSMKKemendikdasmen', topic:'PLC, HMI & SCADA', desc:'Video pembelajaran SMK Teknik Otomasi Industri: mengoperasikan PLC mulai dari wiring hingga menjalankan program.' },
  ...
  { id:'OA1WcpH3Orw', title:'Wecon HMI â€” Modbus RS-485 dari Inverter ke HMI Levi Series', channel:'Wecon Indonesia', channelUrl:'https://www.youtube.com/@weconindonesia', topic:'PLC, HMI & SCADA', desc:'Dasar komunikasi HMI: menghubungkan inverter ke HMI Wecon Levi Series via protokol Modbus RTU (RS-485).' },
  // KOMPLEKS
  ...
  { id:'DP41lE_hyAA', title:'Wecon HMI â€” Komunikasi Modbus dengan Servo Wecon', channel:'Wecon Indonesia', channelUrl:'https://www.youtube.com/@weconindonesia', topic:'PLC, HMI & SCADA', desc:'Integrasi HMI dengan servo drive Wecon via Modbus: setting parameter, display, dan kontrol posisi/kecepatan.' },
...
// BANK PROYEK SIAP PAKAI (Terverifikasi) â€” Wokwi
...
const WOKWI_TEMPLATES = [
  {
    ...
    desc: "Kedipkan LED tiap 1 detik â€” proyek paling dasar untuk memahami struktur setup() dan loop() di Arduino.",
    difficulty: "Mudah",
    tags: ["LED", "Dasar"],
    verified: true,
  ...
  },
  {
    ...
    desc: "Tampilkan teks 'ElektroDict!' pada LCD 16x2 mode parallel 4-bit â€” dasar untuk proyek display.",
    difficulty: "Menengah",
    tags: ["LCD", "Display"],
    verified: true,
  ...
  {
    id: "tpl-servo",
    title: "Servo Sweep 0-180Â°",
    desc: "Gerakkan servo maju-mundur dari 0Â° ke 180Â° dan kembali â€” dasar kontrol posisi.",
    difficulty: "Mudah",
    tags: ["Servo", "Motor"],
    verified: true,
  ...
  },
  {
    ...
    desc: "Tekan tombol untuk menyalakan LED. Memakai INPUT_PULLUP internal Arduino â€” tanpa resistor pull-up.",
    difficulty: "Mudah",
    tags: ["Tombol", "Input"],
    verified: true,
  ...
  "desc": "LED RGB menyala bergantian merah, hijau, biru, dan campurannya â€” latihan dasar PWM 3 kanal.",
  "difficulty": "Mudah",
  "tags": [
    "LED",
    "RGB",
  ...
  "desc": "Modul sensor cahaya LDR menyalakan LED otomatis saat ruangan gelap â€” simulasi lampu jalan hemat energi.",
  "difficulty": "Mudah",
  "tags": [
    "Sensor",
    "LDR",
  ...
  "steps": [
    ...
    },
    {
      ...
      "alur_perakitan": "Tutup sensor (gelapkan) â€” LED menyala otomatis."
    }
  ]
},
  {
  "id": "tpl-servo-knob",
  "title": "Servo Knob",
  "desc": "Putar potensiometer untuk menggerakkan sudut servo 0-180 derajat â€” dasar kontrol posisi analog.",
  "difficulty": "Mudah",
  "tags": [
    "Servo",
    "Potensiometer",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Putar knob â€” servo bergerak mengikuti posisi potensiometer."
    }
  ]
},
  {
  ...
  "desc": "Joystick analog menggerakkan servo secara halus â€” sumbu X mengontrol posisi, sumbu Y mengontrol kecepatan.",
  "difficulty": "Menengah",
  "tags": [
    "Joystick",
    "Servo",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Geser joystick kiri-kanan â€” servo mengikuti."
    }
  ]
},
  {
  ...
  "desc": "Tampilkan angka 0-9 bergantian di display 7-segmen setiap detik â€” belajar decode BCD ke segmen.",
  "difficulty": "Menengah",
  "tags": [
    "Display",
    "7-Segmen",
  ...
  "desc": "Motor stepper bipolar berputar satu arah lalu berbalik â€” dasar kontrol presisi untuk printer/CNC mini.",
  "difficulty": "Menengah",
  "tags": [
    "Motor",
    "Stepper"
  ...
  "desc": "HC-SR04 mengukur jarak; buzzer berbunyi semakin cepat saat objek semakin dekat â€” simulasi sensor parkir.",
  "difficulty": "Menengah",
  "tags": [
    "Sensor",
    "Ultrasonik",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Dekatkan objek â€” bunyi buzzer semakin cepat."
    }
  ]
},
  {
  ...
  "desc": "Suhu & kelembaban dari DHT22 ditampilkan di LCD 1602 â€” kombinasi sensor dan display populer.",
  "difficulty": "Menengah",
  "tags": [
    "Sensor",
    "DHT22",
  ...
  "desc": "Modul HX711 + load cell menimbang beban dan menampilkan berat gram di Serial Monitor â€” dasar timbangan digital.",
  "difficulty": "Sulit",
  "tags": [
    "Sensor",
    "HX711",
  ...
  "desc": "MPU6050 mendeteksi kemiringan sumbu dan menggerakkan servo agar selalu tegak â€” dasar stabilisasi gimbal.",
  "difficulty": "Sulit",
  "tags": [
    "Sensor",
    "MPU6050",
  ...
  "desc": "ESP32 membaca DHT22 lalu mengirim suhu & kelembaban ke Firebase Realtime Database â€” pantau dari dashboard web kapan saja.",
  "difficulty": "Menengah",
  "tags": [
    "ESP32",
    "Firebase",
  ...
  "firebase_setup": [
    "Buka console.firebase.google.com â†’ buat project baru (gratis).",
    "Build â†’ Realtime Database â†’ Create Database (mode test agar mudah dicoba).",
    "Salin URL database (mis. https://xyz-default-rtdb.firebaseio.com) â†’ isi FIREBASE_HOST.",
    "Project settings â†’ Service accounts â†’ Database secrets â†’ salin secret â†’ isi FIREBASE_AUTH.",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Buka Realtime Database â†’ path /sensor â€” suhu & kelembaban ter-update tiap 5 detik."
    }
  ]
},
  {
  ...
  "firebase_setup": [
    "Buat project Firebase gratis â†’ Realtime Database mode test.",
    "Salin URL database â†’ isi FIREBASE_HOST.",
    "Database secrets â†’ isi FIREBASE_AUTH.",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Dekatkan objek ke sensor â€” buzzer berbunyi < 30 cm dan /jarak/bahaya jadi true di Firebase."
    }
  ]
},
  {
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Lewat di depan sensor â€” LED menyala dan /keamanan/gerakan jadi true di dashboard."
    }
  ]
},
  {
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Tutup sensor LDR (gelapkan) â€” LED menyala dan /cahaya/lampu_nyala jadi true."
    }
  ]
},
  {
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Naikkan suhu di atas target â€” relay aktif dan /termostat/beban_nyala jadi true."
    }
  ]
},
  {
  ...
  "desc": "Kontrol posisi servo dari dashboard Firebase â€” tulis nilai 0-180 di path /servo/sudut, dan ESP32 langsung menggerakkan servo.",
  "difficulty": "Menengah",
  "tags": [
    "ESP32",
    "Firebase",
  ...
  "steps": [
    ...
    },
    {
      ...
      "alur_perakitan": "Buka Realtime Database â†’ ubah /servo/sudut menjadi angka 0-180."
    },
    {
      "nama_komponen": "Uji coba",
  ...
  "desc": "Atur warna LED RGB dari dashboard Firebase â€” tulis nilai R, G, B (0-255) di database dan ESP32 menampilkannya via PWM.",
  "difficulty": "Menengah",
  "tags": [
    "ESP32",
    "Firebase",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Dekatkan asap/gas â€” buzzer dan LED menyala, /gas/bahaya jadi true."
    }
  ]
},
  {
  ...
  "desc": "Tombol bel mengaktifkan buzzer dan mengirim notifikasi ke Firebase â€” dashboard mencatat waktu bel ditekan.",
  "difficulty": "Mudah",
  "tags": [
    "ESP32",
    "Firebase",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Tekan tombol â€” buzzer berbunyi dan /bel/ditekan jadi true di Firebase."
    }
  ]
}, {
  "id": "tpl-keypad-lock",
  "title": "Kunci Pintu Keypad 4x4 + LCD",
  "desc": "Keypad 4x4 jadi password lock: masukkan sandi 4 digit, LCD I2C menampilkan status BUKA/TOLAK â€” latihan input & logika kondisi.",
  "difficulty": "Sulit",
  "tags": [
    "Keypad",
    "LCD",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Tekan 1-2-3-4 lalu # â†’ LCD tampil BUKA. Sandi salah â†’ TOLAK."
    }
  ]
},
{
  ...
  "desc": "Modul display 4 digit TM1637 menghitung detik menit (stopwatch) dengan titik dua berkedip â€” latihan display 7-segmen modern.",
  "difficulty": "Menengah",
  "tags": [
    "Display",
    "TM1637",
...
},
{
  ...
  "desc": "Remote infrared (38 kHz) menyalakan/mematikan LED â€” pelajari protokol NEC dan cara membaca sinyal IR dengan Arduino.",
  "difficulty": "Sulit",
  "tags": [
    "IR",
    "Remote",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Klik tombol di widget Remote IR (simulator) â†’ LED toggle nyala/mati, kode tombol tampil di Serial Monitor."
    }
  ]
},
{
  ...
  "desc": "Ring LED NeoPixel 16 pixel menampilkan efek pelangi berjalan â€” pengenalan LED addressable WS2812 dan perpustakaan Adafruit NeoPixel.",
  "difficulty": "Menengah",
  "tags": [
    "LED",
    "NeoPixel",
...
},
{
  ...
  "desc": "Modul RTC DS1307 menjaga waktu real (jam:menit:detik & tanggal) meski board mati â€” ditampilkan di LCD 16x2.",
  "difficulty": "Menengah",
  "tags": [
    "RTC",
    "LCD",
...
},
{
  ...
  "desc": "Satu IC shift register 74HC595 mengendalikan 4 (atau lebih) LED hanya dengan 3 pin Arduino â€” dasar ekspansi output digital.",
  "difficulty": "Menengah",
  "tags": [
    "Shift Register",
    "74HC595",
...
},
{
  ...
  "desc": "Dot matrix 8x8 MAX7219 menampilkan pixel berjalan â€” belajar driver display dengan protokol SPI dan library LedControl.",
  "difficulty": "Sulit",
  "tags": [
    "MAX7219",
    "Matrix",
...
},
{
  ...
  "desc": "Encoder rotary KY-040 mengatur kecerahan LED PWM (dimmer) dan tombolnya sebagai saklar on/off â€” latihan input rotary & PWM.",
  "difficulty": "Menengah",
  "tags": [
    "Encoder",
    "KY-040",
  ...
  "steps": [
    ...
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Putar knob (drag di simulator) â†’ kecerahan berubah. Tekan tombol encoder â†’ LED mati/nyala."
    }
  ]
},
{
  ...
  "desc": "ESP32 membuat web server WiFi â€” buka alamat IP-nya di browser, klik tombol untuk menyalakan/mematikan LED. Tanpa library tambahan!",
  "difficulty": "Menengah",
  "tags": [
    "ESP32",
    "WiFi",
  ...
  "steps": [
    ...
    },
    {
      ...
      "alur_perakitan": "Mulai simulasi â€” buka tab serial untuk melihat alamat IP, lalu buka URL tersebut di browser."
    },
    {
      "nama_komponen": "Uji coba",
      "alur_perakitan": "Klik tombol NYALA/MATI di halaman web â†’ LED ikut menyala/mati."
    }
  ]
},
{
  ...
  "desc": "ESP32 membaca DHT22 lalu menampilkan suhu & kelembaban di layar OLED SSD1306 (I2C) â€” tanpa cloud, data langsung di layar.",
  "difficulty": "Menengah",
  "tags": [
    "ESP32",
    "DHT22",
  ...
  "wokwi_diagram": "{\"version\":1,\"author\":\"ElektroDict\",\"editor\":\"wokwi\",\"parts\":[{\"type\":\"board-esp32-devkit-c-v4\",\"id\":\"esp\",\"top\":0,\"left\":0,\"attrs\":{}},{\"type\":\"wokwi-dht22\",\"id\":\"dht\",\"top\":-140,\"left\":340,\"attrs\":{}},{\"type\":\"board-ssd1306\",\"id\":\"oled\",\"top\":-140,\"left\":540,\"attrs\":{}}],\"connections\":[[\"dht:VCC\",\"esp:3V3\",\"red\",[\"v0\"]],[\"dht:SDA\",\"esp:4\",\"green\",[\"v0\"]],[\"dht:GND\",\"esp:GND.1\",\"black\",[\"v0\"]],[\"oled:VIN\",\"esp:3V3\",\"red\",[\"v0\"]],[\"oled:DATA\",\"esp:21\",\"green\",[\"v0\"]],[\"oled:CLK\",\"esp:22\",\"yellow\",[\"v0\"]],[\"oled:GND\",\"esp:GND.2\",\"black\",[\"v0\"]]]}",
  "steps": [
    {
      "nama_komponen": "DHT22",
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// TENTANG â€” konten About di-embed langsung (tidak fetch README.md)
// agar selalu tampil: offline, Vercel, GitHub Pages, dll.
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
const ABOUT_MD = `# âš¡ ElektroDict

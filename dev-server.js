...
const CSP_VALUE = "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://unpkg.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.jsdelivr.net https://unpkg.com; font-src 'self' https://fonts.gstatic.com https://cdn.jsdelivr.net https://unpkg.com; img-src 'self' data: blob: https://i.ytimg.com https://upload.wikimedia.org https://*.wikipedia.org https://cdn.jsdelivr.net https://*.supabase.co https://unpkg.com; frame-src https://www.youtube.com https://www.youtube-nocookie.com https://wokwi.com https://*.wokwi.com; connect-src 'self' https://api.groq.com https://newsapi.org https://id.wikipedia.org https://en.wikipedia.org https://cdnjs.cloudflare.com https://cjikzpxhqstvgnblxfpv.supabase.co https://cdn.jsdelivr.net https://script.google.com https://script.googleusercontent.com https://openrouter.ai https://*.firebaseio.com https://*.firebasedatabase.app; object-src 'none'; base-uri 'self'; form-action 'self'";
